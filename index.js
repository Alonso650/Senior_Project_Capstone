...
function processData(data) {
    ...
    // Log the parsed Newick data
    var parsedData = parseNewick(data);
    console.log("Parsed Newick data:", parsedData);
    ...
    console.log("Hierarchicial data:", root);
    ...
    function linkStep(startAngle, startRadius, endAngle, endRadius) {
        ...
        return "M" + startRadius * c0 + "," + startRadius * s0
            + (endAngle === startAngle ? "" : "A" + startRadius + "," + startRadius
            + " 0 0 " + (endAngle > startAngle ? 1 : 0)
